...
/////////////////
const BotName = 'DEFANJAYANI BOT'; 
const instagram = 'https://instagram.com/defanjayani'; 
const telegram = 'https://t.me/dhaifan2004'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UC_xM6mnhaTTvxlbh8bYdH5g';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@defanjayani')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@defanjayani`)
})
